...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.purity_rating'
        db.add_column(u'wallpapers_tag', 'purity_rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.purity_rating'
        db.delete_column(u'wallpapers_tag', 'purity_rating')
