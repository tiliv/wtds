...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.purity_rating'
        db.alter_column(u'wallpapers_tag', 'purity_rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Tag.purity_rating'
        db.alter_column(u'wallpapers_tag', 'purity_rating', self.gf('django.db.models.fields.IntegerField')())
