...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wallpaper.purity_rating'
        db.add_column(u'wallpapers_wallpaper', 'purity_rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wallpaper.purity_rating'
        db.delete_column(u'wallpapers_wallpaper', 'purity_rating')
    ...
    models = {
        ...
        u'wallpapers.wallpaper': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'purity_rating': ('django.db.models.fields.IntegerField', [], {}),
