...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wallpaper.raw_ratio'
        db.add_column(u'wallpapers_wallpaper', 'raw_ratio',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wallpaper.raw_ratio'
        db.delete_column(u'wallpapers_wallpaper', 'raw_ratio')
